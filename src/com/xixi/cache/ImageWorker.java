...
public abstract class ImageWorker {
    ...
    public Bitmap getBitmap(Object data,final BitmapCallBack callback){
    	 if (data == null) {
             return null;
         }
     ...
     * @param cacheParams
     */
    public void addImageCache(XiXiApp fragmentManager,
    ...
    private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Object... params) {
            ...
            data = params[0];
            return getBitmapByUrl(params);
        }

		private Bitmap getBitmapByUrl(Object... params) {
