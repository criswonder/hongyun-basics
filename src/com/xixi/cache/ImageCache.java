...
package com.xixi.cache;

import com.example.hongyunbasic.BuildConfig;
...
public class ImageCache {
    ...
    public static ImageCache findOrCreateCache(
    		XiXiApp fragmentManager, ImageCacheParams cacheParams) {
     ...
     *         created.
     */
    public static RetainFragment findOrCreateRetainFragment(XiXiApp fm) {
        // Check to see if we have retained the worker fragment.
        RetainFragment mRetainFragment = (RetainFragment) XiXiApp.findFragmentByTag(TAG);

        // If not retained (or first time running), we need to create and add it.
        if (mRetainFragment == null) {
            mRetainFragment = new RetainFragment();
            XiXiApp.setFragmentByTag(mRetainFragment);
        }
